...
public class BigIntegerPractice {
    ...
    public static void main(String[] args) {
        ...
        BigInteger int1 = new BigInteger("1000");
        BigInteger int2 = new BigInteger("1000");

        BigInteger product = int1.multiply(int2);

      //  System.out.println(product);

        BigInteger muNum = new BigInteger("999999999999999999999999999999999999999999999999999999999999999999999999" +
        ...
        System.out.println(digitSumWithBigInteger(muNum));

        System.out.println("-------------------------------------------------------------------------------------------------");

//        System.out.println(digitSumWithBigInteger(myBigNum));
//        System.out.println("*****************************");
//        System.out.println(digitNumSum(myBigNum));
