...
public class RealEstateCalculator {
    public static void main(String[] args) {
        ...
        if (garage){
            ...
            else propertyPrice+=garageSpots*20000;
        }
        System.out.println("How close is metro station?");
        metroAccessibility = scan.nextFloat();
        if (metroAccessibility>0&&metroAccessibility<=1)propertyPrice+=10000;
        else if (metroAccessibility>1&&metroAccessibility<=3)propertyPrice+=5000;
        System.out.println("How close is highway?");
        highwayAccessibility = scan.nextFloat();
        if (highwayAccessibility>0&&highwayAccessibility<=1)propertyPrice+=15000;
        ...
        if (schoolScore>=4&&schoolScore<8)propertyPrice+=20000;
        else if (schoolScore>=8&&schoolScore<=10)propertyPrice+=45000;
        else propertyPrice+=5000;
